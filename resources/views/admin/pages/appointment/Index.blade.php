...
@section('content')
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">list des Rendez-vous</h4>
                        ...
                        <table class="table text-md-nowrap" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-25p border-bottom-0">patient Phone</th>
                                    <th class="wd-25p border-bottom-0">patient Email</th>
    ...
    <!-- /row -->
    @include('admin.pages.appointment.create')
