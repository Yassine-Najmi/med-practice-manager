                    ...
                    <form method="POST" action="{{ route('admin.employee.update', $item->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" placeholder="Section Name" class="form-control"
                                id="name" value="{{ $item->name }}" aplaceholder="Section Name">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="address" class="form-control" id="adresse"
                                value="{{ $item->address }}" placeholder="Section Adress">
                            @error('address')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="salary" class="form-control" id="salary"
                                value="{{ $item->salary }}" placeholder="Section Salary">
                            @error('salary')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="date" name="hiring_date" class="form-control" id="hiring_date"
                                value="{{ $item->hiring_date }}" placeholder="Section Hiring Date">
                            @error('hiring_date')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
