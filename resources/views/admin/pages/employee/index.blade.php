...
@section('content')
            ...
            <form action="{{ route('employee.search') }}" method="GET">
                <div class="input-group input-group-md ">
                    <input type="text" name="query" value="{{ request()->query('query') }}"
                        class="form-control input-search" placeholder="Chercher un Employee..." />
                        ...
                        <table class="table text-md-nowrap" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-10p border-bottom-0">Work Time</th>
                                    <th class="wd-5p border-bottom-0">Salary</th>
                                    <th class="wd-15p border-bottom-0">Hiring Date</th>
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <form action="{{ route('admin.employee.destroy', $item->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('delete')
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center mt-5 text-danger">Pas de Employee</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
    ...
    <!-- /row -->
    @include('admin.pages.employee.create')
