...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Patients</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Table de
                    Patients</span>
            </div>
        </div>
            ...
            <form action="{{ route('patient.search') }}" method="GET">
                <div class="input-group input-group-md ">
                    <input type="text" name="query" value="{{ request()->query('query') }}"
                        class="form-control input-search" placeholder="Chercher un Patient..." />
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">List des Patients</h4>
                        ...
                        <table class="table text-md-nowrap" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">CNIE</th>
                            ...
                            <tbody>
                                @forelse ($data as $item)
                                    ...
                                    @include('admin.pages.patient.edit')
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center mt-5 text-danger">Pas de Patient</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
