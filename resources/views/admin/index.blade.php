    ...
    <div class="row row-sm">
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-primary-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-16 text-white">Les rendez-vous d'aujourd'hui</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-32 font-weight-bold mb-2 text-white ">{{ $todayCount }}</h4>
                                <p class="mb-0 tx-12 text-white op-7">Nombre total de rendez-vous prévus pour aujourd'hui
                                </p>
                            </div>
                            <span class="float-right my-auto ml-auto">
                                <span class="mdi mdi-calendar-today text-white tx-36"></span>
                            </span>
                        </div>
                    </div>
                </div>
                <span id="compositeline" class="pt-1">10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10</span>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-danger-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-16 text-white">Les rendez-vous de demain</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-32 font-weight-bold mb-2 text-white">{{ $tomorrowCount }}</h4>
                                <p class="mb-0 tx-12 text-white op-7">Nombre total de rendez-vous prévus pour demain</p>
                            </div>
                            <span class="float-right my-auto ml-auto">
                                <span class="mdi mdi-view-day text-white tx-36"></span>

                            </span>
                        </div>
                    </div>
                </div>
                <span id="compositeline2" class="pt-1">10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10</span>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-success-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-16 text-white">Les rendez-vous de cette semaine</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-32 font-weight-bold mb-2 text-white">{{ $weekCount }}</h4>
                                <p class="mb-0 tx-12 text-white op-7">Nombre total de rendez-vous prévus cette semaine</p>
                            </div>
                            <span class="float-right my-auto ml-auto">
                                <span class="mdi mdi-view-week text-white tx-36"></span>
                            </span>
                        </div>
                    </div>
                </div>
                <span id="compositeline3" class="pt-1">10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10</span>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-warning-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-16 text-white">Les rendez-vous de ce mois</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-32 font-weight-bold mb-2 text-white">{{ $monthCount }}</h4>
                                <p class="mb-0 tx-12 text-white op-7">Nombre total de rendez-vous prévus ce mois</p>
                            </div>
                            <span class="float-right my-auto ml-auto">
                                <span class="mdi mdi-calendar-clock text-white tx-36"></span>
                            </span>
                        </div>
                    </div>
                </div>
                <span id="compositeline4" class="pt-1">10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10</span>
                ...
                <div class="list-group">
                    @forelse ($appointmentsToday as $item)
                        <div class="list-group-item border-top-0">
                            <p class="mdi mdi-account text-primary tx-24"></p>
                    ...
                    <table class="table table-striped table-bordered mb-4 text-sm-nowrap text-lg-nowrap text-xl-nowrap">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-lg-25p ">la date</th>
                                <th class="wd-lg-25p">à partir de</th>
                                {{-- <th class="wd-lg-25p tx-right">Tax Witheld</th> --}}
                            </tr>
                        </thead>
                        <tbody>
                            @forelse ($appointmentsWeek as $item)
                                <tr>
                                    <td>{{ $item->patient->name }}</td>
                                    <td class="tx-medium tx-inverse">
                                        {{ Carbon\Carbon::parse($item->date)->translatedFormat('d F Y') }}</td>
                                    <td class="tx-medium tx-inverse">
                                        {{ Carbon\Carbon::parse($item->time)->translatedFormat('H:i') }}</td>
